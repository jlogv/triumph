    ...
    class Request
    {
        ...
        public static function isSecure(): bool
        {
            ...
            if (isset($_SERVER['SERVER_PORT'])) {
                if ($_SERVER['SERVER_PORT'] == 443 || $_SERVER['SERVER_PORT'] == 8443) return true;
            }

            if (isset($_SERVER['HTTP_X_FORWARDED_PORT'])) {
                if ($_SERVER['HTTP_X_FORWARDED_PORT'] == 443 || $_SERVER['HTTP_X_FORWARDED_PORT'] == 8443) return true;
            }

            if (isset($_SERVER['SSL_PROTOCOL'])) {
                if (Strings::length($_SERVER['SSL_PROTOCOL']) > 0) return true;
            }
        ...
        {
            if (self::getMethod() == 'GET') return true; else return false;
        }
        ...
        {
            if (self::getMethod() == 'POST') return true; else return false;
        }
        ...
        {
            if (self::getMethod() == 'PUT') return true; else return false;
        }
        ...
        {
            if (self::getMethod() == 'PATCH') return true; else return false;
        }
